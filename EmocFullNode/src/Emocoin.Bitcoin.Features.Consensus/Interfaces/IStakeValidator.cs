...
namespace Emocoin.Bitcoin.Features.Consensus.Interfaces
{
    /// <summary>
    /// Provides functionality for checking validity of PoS blocks.
    /// See <see cref="Emocoin.Bitcoin.Features.Miner.PosMinting"/> for more information about PoS solutions.
    /// </summary>
