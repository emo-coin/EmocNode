...
{
    /// <summary>
    /// Checks if <see cref="EmocoinMain"/> network block's header has a valid block version.
    /// </summary>
    public class EmocoinHeaderVersionRule : HeaderVersionRule
    {
        /// <inheritdoc />
        ...
        public override void Run(RuleContext context)
        {
            ...
            // The emocoinX block validation rules mandate if (!IsProtocolV3(nTime)) && (nVersion > 7), then reject block.
            ...
            // The block versions have therefore been version 7 since genesis on Emocoin mainnet.
