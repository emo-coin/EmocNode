...
{
    /// <summary>
    /// Push the modified <see cref="UnspentOutputSet"/> back to the underlying cache.
    /// </summary>
    ...
    public class FetchCoinviewRule : UtxoStoreConsensusRule
    {
        ...
        public override Task RunAsync(RuleContext context)
        {
            ...
            bool enforceBIP30 = context.ValidationContext.ChainedHeaderToValidate.Height > this.Parent.Checkpoints.GetLastCheckpointHeight() ? context.Flags.EnforceBIP30 : false;
