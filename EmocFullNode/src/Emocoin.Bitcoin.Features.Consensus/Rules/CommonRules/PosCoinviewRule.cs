...
namespace Emocoin.Bitcoin.Features.Consensus.Rules.CommonRules
{
    ...
    /// </summary>
    /// <remarks>Be aware that changing anything here may change it for <see cref="EmocCoinviewRule"/> as well.</remarks>
    public class PosCoinviewRule : CoinViewRule
    {
        ...
        public override void CheckBlockReward(RuleContext context, Money fees, int height, Block block)
        {
            ...
            if (BlockStake.IsProofOfStake(block))
            {
                ...
                //find rewarded emoji
                foreach (var txOut in block.Transactions[1].Outputs)
                {
