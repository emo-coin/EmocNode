...
{
    /// <summary>
    /// A rule that will verify the block time drift is according to the PoS consensus rules for the <see cref="EmocoinMain"/> network (and its test networks).
    /// New networks must use the <see cref="PosFutureDriftRule"/>.
    /// </summary>
    public class EmocoinBugFixPosFutureDriftRule : PosFutureDriftRule
    {
        ...
        {
            // This is a specific Emocoin bug fix where the blockchain drifted 24 hour ahead as the protocol allowed that.
