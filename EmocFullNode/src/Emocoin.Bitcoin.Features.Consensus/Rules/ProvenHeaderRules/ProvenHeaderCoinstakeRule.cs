...
namespace Emocoin.Bitcoin.Features.Consensus.Rules.ProvenHeaderRules
{
    /// <summary>
    ...
    /// <seealso cref="T:Emocoin.Bitcoin.Features.Consensus.Rules.ProvenHeaderRules.ProvenHeaderRuleBase" />
