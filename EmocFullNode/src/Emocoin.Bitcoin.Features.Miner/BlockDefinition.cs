...
using Emocoin.Bitcoin.Features.Miner.Comparers;
...
namespace Emocoin.Bitcoin.Features.Miner
{
    ...
    public abstract class BlockDefinition
    {
        ...
        protected virtual void CreateCoinbase()
        {
            ...
            var emoji = Emoji.GetSlotsByBlockHeight(this.ChainTip.Height);
            this.coinbase.AddOutput(new TxOut(Money.Zero, this.scriptPubKey, emoji));
        ...
        protected virtual void AddTransactions(out int nPackagesSelected, out int nDescendantsUpdated)
        {
            ...
            while (ancestorScoreList.Any() || mapModifiedTx.Any())
            {
                ...
                if (!mempoolEntry.Transaction.Outputs.Any(o => o.ScriptPubKey == EmocCoinstakeRule.CirrusTransactionTag(this.Network.CirrusRewardDummyAddress)))
                {
