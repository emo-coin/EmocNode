...
using Emocoin.Bitcoin.Features.Miner.Models;
...
[assembly: InternalsVisibleTo("Emocoin.Bitcoin.Features.Miner.Tests.Controllers")]
namespace Emocoin.Bitcoin.Features.Miner.Controllers
{
    /// <summary>
