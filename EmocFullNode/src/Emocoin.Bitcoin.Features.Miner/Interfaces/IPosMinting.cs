...
using NBitcoin;
using Emocoin.Bitcoin.Features.Miner.Staking;
using Emocoin.Bitcoin.Mining;

namespace Emocoin.Bitcoin.Features.Miner.Interfaces
{
    /// <summary>
    ...
    public interface IPosMinting
    {
        ...
        /// <see cref="https://github.com/emocoinproject/emocoinX/blob/47851b7337f528f52ec20e86dca7dcead8191cf5/src/rpcblockchain.cpp#L16"/>.
        /// </remarks>
        ...
        /// <see cref="https://github.com/emocoinproject/emocoinX/blob/47851b7337f528f52ec20e86dca7dcead8191cf5/src/rpcblockchain.cpp#L74"/>.
        /// </para>
        /// </remarks>
