...
[assembly: InternalsVisibleTo("Emocoin.Bitcoin.Features.Miner.Tests")]
...
namespace Emocoin.Bitcoin.Features.Miner
{
    ...
    public static class FullNodeBuilderMiningExtension
    {
        ...
        /// <param name="fullNodeBuilder">The object used to build the current node.</param>
        /// <returns>The full node builder, enriched with the new component.</returns>
        public static IFullNodeBuilder AddPowPosMining(this IFullNodeBuilder fullNodeBuilder, bool emocMode)
        {
            LoggingConfiguration.RegisterFeatureNamespace<MiningFeature>("mining");
            ...
            fullNodeBuilder.ConfigureFeature(features =>
            {
                features
                    ...
                    .FeatureServices(services =>
                    {
                        ...
                        if (emocMode)
                            services.AddSingleton<IPosMinting, EmocMinting>();
                        else
