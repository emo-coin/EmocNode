...
using Emocoin.Bitcoin.Base.Deployments.Models;
...
using Emocoin.Bitcoin.Features.RPC.ModelBinders;
using Emocoin.Bitcoin.Features.RPC.Models;
...
namespace Emocoin.Bitcoin.Features.RPC.Controllers
{
    /// <summary>
