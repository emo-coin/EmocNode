...
using Emocoin.Bitcoin.Controllers;
            ...
            try
            {
                ...
                foreach (var input in rawTx.Inputs.ToArray())
                {
                    ...
                    foreach (Wallet wallet in this.walletManager.GetWallets())
                    {
                        ...
                        {
                            coins.Add(new Coin(unspent.Transaction.Id, (uint)unspent.Transaction.Index, unspent.Transaction.Amount, unspent.Transaction.ScriptPubKey, Emoji.GetRandomPureBreed()));
