...
namespace Emocoin.Bitcoin.Networks.Deployments
{
    /// <summary>
    /// BIP9 deployments for the Emocoin network.
    /// </summary>
    public class EmocoinBIP9Deployments : BIP9DeploymentsArray
    {
        ...
        /// </summary>
        public EmocoinBIP9Deployments() : base(NumberOfDeployments)
        {
        }
