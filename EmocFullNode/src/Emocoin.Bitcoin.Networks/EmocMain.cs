...
namespace Emocoin.Bitcoin.Networks
{
    public class EmocMain : Network
    {
        public EmocMain()
        {
            ...
            this.CirrusRewardDummyAddress = "CPqxvnzfXngDi75xBJKqi4e6YrFsinrJka"; // Cirrus main address - TODO change to EMOC main addy
            ...
            this.GenesisTime = 1624310594; // Jun 21, 2021
            ...
            Block genesisBlock = EmocNetwork.CreateGenesisBlock(consensusFactory, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward, "emocoinplatform.com/2021/06/25/introducing-emoc/");
            ...
            this.Consensus = new NBitcoin.Consensus(
                ...
                coinType: 105555,//not registered emocoin, we need open source first // https://github.com/satoshilabs/slips/blob/master/slip-0044.md
            ...
            this.Checkpoints = new Dictionary<int, CheckpointInfo>
            {
                ...
                { 150000, new CheckpointInfo(new uint256("0x48bb4c2f08088da9990e23f19cb4b9a094bdf7791f86f77a98d08e5d2b06c1ce"), new uint256("0x14f80d627e7727f4da4a5945ddb77e2821369246c72f1c6ca754c6509a4eef60")) }
            };
            ...
            {
                new DNSSeedData("emocmainnet1.emocoinnetwork.com", "emocmainnet1.emocoinnetwork.com"),
                new DNSSeedData("emocmainnet2.emocoinnetwork.com", "emocmainnet2.emocoinnetwork.com")
            };
