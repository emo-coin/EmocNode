...
{
    public class EmocoinMain : Network
    {
        ...
        public const string EmocoinRootFolderName = "emocoin";

        /// <summary> The default name used for the Emocoin configuration file. </summary>
        public const string EmocoinDefaultConfigFilename = "emocoin.conf";
        ...
        public EmocoinMain()
        {
            ...
            this.RootFolderName = EmocoinRootFolderName;
            this.DefaultConfigFilename = EmocoinDefaultConfigFilename;
            ...
            Block genesisBlock = CreateEmocoinGenesisBlock(consensusFactory, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward);
            ...
            var bip9Deployments = new EmocoinBIP9Deployments()
            {
                [EmocoinBIP9Deployments.TestDummy] = new BIP9DeploymentsParameters("TestDummy", 28,
                ...
                [EmocoinBIP9Deployments.CSV] = new BIP9DeploymentsParameters("CSV", 0,
                    new DateTime(2019, 10, 1, 0, 0, 0, DateTimeKind.Utc),
                    new DateTime(2020, 10, 1, 0, 0, 0, DateTimeKind.Utc),
                    BIP9DeploymentsParameters.DefaultMainnetThreshold),

                [EmocoinBIP9Deployments.Segwit] = new BIP9DeploymentsParameters("Segwit", 1,
                    new DateTime(2019, 10, 1, 0, 0, 0, DateTimeKind.Utc),
                    new DateTime(2020, 10, 1, 0, 0, 0, DateTimeKind.Utc),
                    BIP9DeploymentsParameters.DefaultMainnetThreshold),

                [EmocoinBIP9Deployments.ColdStaking] = new BIP9DeploymentsParameters("ColdStaking", 2, 
            ...
            var encoder = new Bech32Encoder("emocoin");
            this.Bech32Encoders[(int)Bech32Type.WITNESS_PUBKEY_ADDRESS] = encoder;
            this.Bech32Encoders[(int)Bech32Type.WITNESS_SCRIPT_ADDRESS] = encoder;

            this.DNSSeeds = new List<DNSSeedData>
            {
                new DNSSeedData("mainnet1.emocoinnetwork.com", "mainnet1.emocoinnetwork.com"),
                new DNSSeedData("mainnet2.emocoinnetwork.com", "mainnet2.emocoinnetwork.com")
            };
            ...
            this.StandardScriptsRegistry = new EmocoinStandardScriptsRegistry();
        ...
        protected void RegisterRules(IConsensus consensus)
        {
            consensus.ConsensusRules
                ...
                .Register<EmocoinBugFixPosFutureDriftRule>()
        ...
        protected static Block CreateEmocoinGenesisBlock(ConsensusFactory consensusFactory, uint nTime, uint nNonce, uint nBits, int nVersion, Money genesisReward)
        {
            string pszTimestamp = "http://www.theonion.com/article/olympics-head-priestess-slits-throat-official-rio--53466";

            Transaction txNew = consensusFactory.CreateTransaction();
            txNew.Version = 1;
            // TODO: Need to remove the Emocoin* networks from the solution (they will remain in SBFN)
            //txNew.Time = nTime;
