...
using Emocoin.Bitcoin.BlockPulling;
...
using Emocoin.Bitcoin.Consensus.Validators;
using Emocoin.Bitcoin.EventBus;
using Emocoin.Bitcoin.Interfaces;
using Emocoin.Bitcoin.P2P;
using Emocoin.Bitcoin.P2P.Peer;
using Emocoin.Bitcoin.P2P.Protocol.Behaviors;
using Emocoin.Bitcoin.P2P.Protocol.Payloads;
using Emocoin.Bitcoin.Persistence;
using Emocoin.Bitcoin.Persistence.ChainStores;
using Emocoin.Bitcoin.Persistence.KeyValueStores;
using Emocoin.Bitcoin.Signals;
using Emocoin.Bitcoin.Utilities;

[assembly: InternalsVisibleTo("Emocoin.Bitcoin.Tests")]
[assembly: InternalsVisibleTo("Emocoin.Bitcoin.Tests.Common")]
[assembly: InternalsVisibleTo("Emocoin.Bitcoin.IntegrationTests.Common")]
[assembly: InternalsVisibleTo("Emocoin.Bitcoin.Features.Consensus.Tests")]
[assembly: InternalsVisibleTo("Emocoin.Bitcoin.IntegrationTests")]
    ...
    public sealed class BaseFeature : FullNodeFeature
    {
        ...
        public override async Task InitializeAsync()
        {
            ...
            if (this.provenBlockHeaderStore != null)
            {
                ...
                // https://github.com/emocoinproject/EmocoinBitcoinFullNode/issues/2503
