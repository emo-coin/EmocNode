namespace Emocoin.Bitcoin.Consensus
{
    ...
    public static class ConsensusErrors
    {
        ...
        public static ConsensusError BadTransactionEmoji => new ConsensusError("bad-txns-emoji", "invalid emojis in txout");
        ...
        public static ConsensusError BadCoinbaseEmoji => new ConsensusError("bad-cb-emoji", "coinbase pays bad emoji");
