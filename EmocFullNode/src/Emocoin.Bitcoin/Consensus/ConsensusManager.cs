...
using Emocoin.Bitcoin.Consensus.PerformanceCounters.ConsensusManager;
using Emocoin.Bitcoin.Consensus.ValidationResults;
    ...
    public class ConsensusManager : IConsensusManager
    {
        ...
        private void ProcessDownloadQueueLocked()
        {
            while (this.toDownloadQueue.Count > 0)
            {
                ...
                // To fix issue https://github.com/emocoinproject/EmocoinBitcoinFullNode/issues/2294#issue-364513736
