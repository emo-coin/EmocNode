...
using Emocoin.Features.SQLiteWalletRepository.External;
using Emocoin.Features.SQLiteWalletRepository.Tables;
...
namespace Emocoin.Features.SQLiteWalletRepository
{
    public class TransactionsToLists : TransactionsToListsBase
    {
        ...
        public override void RecordSpend(HashHeightPair block, TxIn txIn, string emoji, string pubKeyScript, bool isCoinBase, long spendTime, Money totalOut, uint256 spendTxId, int spendIndex)
        {
