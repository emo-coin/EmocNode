...
namespace NBitcoin
{
    ...
    public class Coin : ICoin
    {
        ...
        public Coin(uint256 fromTxHash, uint fromOutputIndex, Money amount, Script scriptPubKey, Emoji emoji)
        {
            this.Outpoint = new OutPoint(fromTxHash, fromOutputIndex);
            this.TxOut = new TxOut(amount, scriptPubKey, emoji);
        }
    ...
    public class ScriptCoin : Coin
    {
        ...
        internal ScriptCoin(uint256 txHash, uint outputIndex, Money amount, Script scriptPubKey, Script redeem)
            : base(txHash, outputIndex, amount, scriptPubKey, Emoji.GetRandomPureBreed())
        {
            this.Redeem = redeem;
        }
