...
namespace NBitcoin
{
    ...
    public abstract class Network
    {
        ...
        /// <summary>
        /// The name of the root folder containing blockchains operating with the same consensus rules (for now, this will be bitcoin or emocoin).
        /// </summary>
        ...
        /// Some more details: As an example, the target for the Emocoin Main network is 00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff.
        ...
        public static Block MineGenesisBlock(ConsensusFactory consensusFactory, string coinbaseText, Target target, Money genesisReward, int version = 1)
        {
            if (consensusFactory == null)
                throw new ArgumentException($"Parameter '{nameof(consensusFactory)}' cannot be null. Use 'new ConsensusFactory()' for Bitcoin-like proof-of-work blockchains and 'new PosConsensusFactory()' for Emocoin-like proof-of-stake blockchains.");
