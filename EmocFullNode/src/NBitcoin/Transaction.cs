...
namespace NBitcoin
{
    ...
    public class TxOut : IBitcoinSerializable, IDestination
    {
        ...
        public TxOut(Money value, Script scriptPubKey, Emoji emoji = null)
        {
            this.Value = value;
            ...
            if (emoji != null)
                this.emoji = emoji;// == null ? Emoji.Empty : emoji;
            else
                this.emoji = Emoji.GetRandomPureBreed();
        }
        ...
        private Emoji emoji;// = Emoji.Empty;
        ...
        public void ReadWrite(BitcoinStream stream)
        {
            ...
            stream.ReadWrite(ref this.emoji);
        }
        ...
        public override string ToString()
        {
            return $"{nameof(this.Value)}={this.Value},{nameof(this.Emoji)}={this.Emoji},{nameof(this.ScriptPubKey)}={this.ScriptPubKey}";
        }
    }
