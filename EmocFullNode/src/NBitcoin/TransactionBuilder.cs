    ...
    public class TransactionBuilder
    {
        ...
        internal class BuilderGroup
        {
            ...
            private IMoney SetChange(TransactionBuildingContext ctx)
            {
                ...
                string emoji = ctx.Group.Coins.Last().Value.TxOut.Emoji.ToString();
                var emo = new Emoji(emoji);
                ctx.Transaction.AddOutput(new TxOut(changeAmount, ctx.Group.ChangeScript[(int)ChangeType.Uncolored], emo));
                return changeAmount;
            }
        ...
        /// <returns></returns>
        public TransactionBuilder Send(IDestination destination, Money amount, String emoji = "")
        {
        ...
        /// <param name="amount">The amount</param>
        /// <returns></returns>
        public TransactionBuilder Send(Script scriptPubKey, Money amount, string emoji="")
        {
            ...
            {
                emo = Emoji.GetRandomPureBreed();
            }

            var builder = new SendBuilder(new TxOut(amount, scriptPubKey, emo));
        ...
        public Transaction BuildTransaction(bool sign, SigHash sigHash)
        {
            ...
            //{
            //    //ctx.Transaction.Outputs[i].Emoji = Emoji.GetRandomPureBreed();
            //}
        ...
        public TransactionBuilder AddCoins(Transaction transaction)
        {
            ...
            AddCoins(transaction.Outputs.Select((o, i) => new Coin(txId, (uint)i, o.Value, o.ScriptPubKey, o.Emoji)).ToArray());
            return this;
        }
